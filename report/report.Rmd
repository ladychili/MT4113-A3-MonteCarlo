...
```{r power-plot-t, fig.cap="Power of Student's t Test under Different Scenarios"}
include_graphics("../figure/power_t.pdf")
```

```{r power-plot-mw, fig.cap="Power of Mann-Whitney U Test under Different Scenarios"}
include_graphics("../figure/power_mw.pdf")
```
...
```{r size-plot-t, fig.cap="Size of Student's t Test under Different Scenarios"}
include_graphics("../figure/size_t.pdf")
```

```{r size-plot-mw, fig.cap="Size of Mann-Whitney U Test under Different Scenarios"}
include_graphics("../figure/size_mw.pdf")
```
